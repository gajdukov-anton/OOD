using GumballMachine.NaiveGumballMachine;
using GumballMachine.Utils;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System.IO;


namespace GumballMachineTest.NaiveGumballMachine
{
    [TestClass]
    public class NaiveGumballMachineTest
    {
        [TestMethod]
        public void InitializeNaiveGumballMachineWithSomeBallsTest()
        {
